...
fun main() {
    MeepMeepVisualizer.addRobot(
        ...
        {
            sequential {
                +Constants.drive.followTrajectory(CompetitionTrajectoryFactory.f4F5StartToLowJunction)
                +Constants.drive.followTrajectory(CompetitionTrajectoryFactory.f4F5LowJunctionToSignal)
            }
        },
