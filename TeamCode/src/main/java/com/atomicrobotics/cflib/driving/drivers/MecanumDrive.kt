...
class MecanumDrive(constants: MecanumDriveConstants,
    ...
    private val leftFront = MotorEx(constants.LEFT_FRONT_NAME, constants.MOTOR_TYPE, constants.TOTAL_GEAR_RATIO)
    private val leftBack = MotorEx(constants.LEFT_FRONT_NAME, constants.MOTOR_TYPE, constants.TOTAL_GEAR_RATIO)
    private val rightBack = MotorEx(constants.LEFT_FRONT_NAME, constants.MOTOR_TYPE, constants.TOTAL_GEAR_RATIO)
    private val rightFront = MotorEx(constants.LEFT_FRONT_NAME, constants.MOTOR_TYPE, constants.TOTAL_GEAR_RATIO)
    ...
    override fun initialize() {
        ...
        leftBack.motor.direction = constants.LEFT_BACK_DIRECTION
        leftFront.motor.direction = constants.LEFT_FRONT_DIRECTION
        rightBack.motor.direction = constants.RIGHT_BACK_DIRECTION
        rightFront.motor.direction = constants.RIGHT_FRONT_DIRECTION
    }
